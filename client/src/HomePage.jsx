...
const HomePage = () => {
  return (
    <div>
        <MainLayout> 
          <div className="bg-gray-300 py-72 px-12">
              <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold"> Easy Ways to Build a Beautiful Resume </h1>
          ...
          <div className='w-full h-full flex pb-1' align="center">
              <Layout />
              <Preview />
          </div>
        </MainLayout>
